...
public class AssemblerScenes {
    public static void basicAssemblerScene(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world().showIndependentSection(util.select().fromTo(0, 0, 0, 1, 0, 4)
                .add(util.select().fromTo(3, 0, 0, 4, 0, 4)), Direction.UP);
        scene.idle(5);

        for(int z = 0; z < 5; ++z) {
            scene.world().showIndependentSection(util.select().position(2, 0, z), Direction.DOWN);
            scene.idle(2);
        }
        ...
        scene.idle(17);
        scene.world().showIndependentSection(assemblySection, Direction.EAST);
        scene.idle(20);
        ...
        scene.world().showIndependentSection(util.select().position(assemblerPos.above()), Direction.DOWN);
        scene.idle(10);
