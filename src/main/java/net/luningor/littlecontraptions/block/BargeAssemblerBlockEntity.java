package net.luningor.littlecontraptions.block;

import net.luningor.littlecontraptions.entity.ContraptionBargeEntity;
import net.luningor.littlecontraptions.setup.LCBlockEntityTypes;
import net.luningor.littlecontraptions.setup.LCBlocks;
import net.luningor.littlecontraptions.createlegacycode.VecHelper;
